      ...
      for (let i = 1; i < linhas.length; i++) {
        ...
        try {
          ...
          const titulo = {
            ...
            cod_credor: dados.COD_CREDOR || null,
            cod_devedor: dados.COD_DEVEDOR || null,
            tp_pessoa: dados.TP_PESSOA || null,
            ie_rg: dados.IE_RG || null,
            categoria: dados.CATEGORIA || null,
            gerente: dados.GERENTE || null,
            score: dados.SCORE ? parseInt(dados.SCORE) : null,
            fone_2: dados['FONE 2'] || null,
            fone_obs1: dados.FONE_OBS1 || null,
            fone_obs2: dados.FONE_OBS2 || null,
            fone_3: dados['FONE 3'] || null,
            fone_obs3: dados.FONE_OBS3 || null,
            ...
            cep: dados.CEP || null,
            parcela: dados.PARCELA ? parseInt(dados.PARCELA) : null,
            contrato: dados.CONTRATO || null,
            data_programada: converterData(dados.DT_PROGRAMADA),
            valor_saldo: dados.VL_SALDO ? parseFloat(dados.VL_SALDO.replace(',', '.')) : null,
            tipo_negocio: dados.TIPO_NEGOCIO || null,
            tipo_titulo: dados.TIPO_TITULO || null,
            portador: dados.PORTADOR || null,
            nosso_numero: dados.NOSSO_NUMERO || null,
            linha_digitavel: dados.LINHA_DIGITAVEL || null,
            cod_barra: dados.COD_BARRA || null,
            complemento1: dados.COMPLEMENTO1 || null,
            complemento2: dados.COMPLEMENTO2 || null,
            complemento3: dados.COMPLEMENTO3 || null
          };
